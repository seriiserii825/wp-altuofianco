...
<?php if ( is_singular( 'solutions' ) ):?>
    <div class="buttom_sol">
	<a class="button_post_solution" href="https://altuofianco.com/21E45" target="_blank">Richiedi informazioni <i class="vc_btn3-icon fa fa-arrow-circle-right"></i></a>
	</div>
